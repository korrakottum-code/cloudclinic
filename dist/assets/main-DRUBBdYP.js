(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}})();const i={lineOA:"@Cloud-clinic",lineLink:"https://line.me/ti/p/~@Cloud-clinic",phone:"065-749-2944",phoneTel:"tel:0657492944",facebook:"https://www.facebook.com/CloudClinickk",googleMaps:"https://maps.app.goo.gl/rSfu97bqaFn2N2Sb6",googleMapsEmbed:"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3826.9!2d102.8364826!3d16.4376822!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31228965b59304e5%3A0xc1d3f252f134c352!2sCloud%20Clinic%20-%20%E0%B8%84%E0%B8%A5%E0%B8%B2%E0%B8%A7%E0%B8%94%E0%B9%8C%E0%B8%84%E0%B8%A5%E0%B8%B4%E0%B8%99%E0%B8%B4%E0%B8%81%20%E0%B8%82%E0%B8%AD%E0%B8%99%E0%B9%81%E0%B8%81%E0%B9%88%E0%B8%99!5e0!3m2!1sth!2sth!4v1",address:"1/1 ถ.กลางเมือง ต.ในเมือง อ.เมือง จ.ขอนแก่น 40000 (ใกล้ศึกษาภัณฑ์ขอนแก่น)",hours:"เปิดบริการ 12.00 - 20.00 น. (ปิดทุกวันพุธ)"};function l(e=""){const a=document.createElement("nav");a.className="navbar",a.id="navbar",window.location.pathname.includes("/iv-drip/");const t="/";a.innerHTML=`
    <div class="navbar__inner">
      <a href="/" class="navbar__logo" aria-label="Cloud Clinic Home">
        <img src="${t}images/logo.jpg" alt="Cloud Clinic" class="navbar__logo-img">
      </a>
  ...
  `,document.body.appendChild(e)}function p(e=""){l(e),c(),d(),v(),f(),m(),u()}function v(){const e=document.getElementById("hamburger"),a=document.getElementById("navLinks"),t=document.getElementById("navOverlay");e&&(e.addEventListener("click",()=>{e.classList.toggle("active"),a.classList.toggle("open"),t.classList.toggle("active"),document.body.style.overflow=a.classList.contains("open")?"hidden":""}),t?.addEventListener("click",()=>{e.classList.remove("active"),a.classList.remove("open"),t.classList.remove("active"),document.body.style.overflow=""}),a?.querySelectorAll(".navbar__link").forEach(s=>{s.addEventListener("click",()=>{e.classList.remove("active"),a.classList.remove("open"),t?.classList.remove("active"),document.body.style.overflow=""})}))}function f(){const e=new IntersectionObserver(a=>{a.forEach(t=>{t.isIntersecting&&(t.target.classList.add("is-visible"),e.unobserve(t.target))})},{threshold:.1,rootMargin:"0px 0px -50px 0px"});document.querySelectorAll(".animate-on-scroll").forEach(a=>{e.observe(a)})}function m(){const e=document.getElementById("navbar");e&&window.addEventListener("scroll",()=>{window.scrollY>50?e.classList.add("scrolled"):e.classList.remove("scrolled")},{passive:!0})}function u(){const e=document.querySelectorAll(".hero__cloud");e.length&&window.addEventListener("scroll",()=>{const a=window.scrollY;e.forEach((t,s)=>{const o=(s+1)*.15;t.style.transform=`translateY(${a*o}px)`})},{passive:!0})}export{p as i};
