import{i as r,I as e}from"./main-Nkk0AcdJ.js";r("home");const d=document.getElementById("standardDrips");e.standard.forEach((a,s)=>{d.innerHTML+=`
      ...
      `});const c=document.getElementById("premiumDrips");e.premium.forEach((a,s)=>{c.innerHTML+=`
        <a href="./iv-drip/${a.id}/" class="drip-card drip-card--premium" style="text-decoration:none; color:inherit; display:flex; flex-direction:column;">
          <div class="drip-card__image">
            <img src="./${a.image}" alt="${a.name}" loading="lazy">
          </div>
          <div class="drip-card__header">
